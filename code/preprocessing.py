...
def preprocess_data():
    ...
    # Trivia QA dataset -- some duplicates
...
def train_val_test_split(processed_questions, processed_answers):
...
def pad_corpus(QUESTION, ANSWER):
    ...
    for line in ANSWER:
        ...
        padded_ANSWER = [START_TOKEN] + padded_ANSWER + [STOP_TOKEN] + [PAD_TOKEN] * (
                    ANSWER_WINDOW_SIZE - len(padded_ANSWER) - 1)
